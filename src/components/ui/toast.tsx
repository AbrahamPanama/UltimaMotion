...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 z-[100] flex max-h-screen w-full flex-col p-2 sm:p-4 sm:right-0 sm:flex-col max-w-[300px] sm:max-w-[420px] left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0",
      className
    )}
    {...props}
  />
